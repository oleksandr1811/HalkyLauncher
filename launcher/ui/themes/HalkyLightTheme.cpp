...
QString HalkyLightTheme::appStyleSheet()
{
    return "QMainWindow, QDockWidget {background-color: #ffffff;}QWidget {border-color: rgba(255, 255, 255, 8);font-family: \"Segoe UI "
           ...
           "QObject::tab, QObject::section {outline: 0;selection-color: #000000;border-radius: 2px;selection-background-color: rgba(203, "
           "130, 126, 200);alternate-background-color: transparent;}QObject::handle {margin: 2px;background: rgba(215, 130, "
           "126);}QObject::handle:active {margin: 2px;background: rgba(215, 130, 126, 200);}QDialog, QWizard *, QCalendarWidget *, "
           "#qswPages > QObject {background-color: #ffffff;color: #000000;}QToolBar {background-color: transparent;spacing: 0;padding: "
           "8px;}QToolBar::separator {background: rgba(255, 255, 255, 20);height: 0;margin: 0;}QToolButton {background-color: rgba(0, "
           "0, 0, 0);border: 1px solid transparent;border-radius: 6px;padding: 2px;margin-left: 8px;}QToolButton[popupMode=\"1\"] "
           "{padding-right: 20px;}QToolButton:on {background-color: rgba(234, 157, 52, 18);}QToolButton:hover {background-color: "
           "rgba(215, 130, 126, 23);}QToolButton:pressed {background-color: rgba(234, 157, 52, 7);border: 1px solid rgba(234, 157, 52, "
           "8);color: #000000;}QToolButton::menu-indicator {image: url(:/icons/fluent/resources/ComboBox.png);width: 32px;height: "
           "38px;}QToolButton::menu-arrow {image: url(:/icons/fluent/resources/ComboBox.png);width: 20px;height: 100%;border-left: "
           "1px solid rgba(0, 0, "
           "0, 8);}QToolButton::menu-button {background: rgba(255, 255, 255, 0%);border: none;}QMenuBar {background-color: "
           "transparent;color: "
           "#000000;padding: 5px;}QMenuBar::item {background-color: transparent;padding: 6px 10px;border-radius: "
           "4px;}QMenuBar::item:selected {background-color: rgba(255, 255, 255, 20);}QMenuBar::item:pressed {background-color: rgba(0, "
           "0, 0, 13);color: #333333;}QMenu {background-color: #ffffff;padding-left: 1px;padding-top: 1px;border: 1px solid rgba(0, "
           "0, 0, 8);border-radius: 0px;}QMenu::indicator, QMenu::icon {left: 4px;}QMenu::item {background-color: transparent;padding: "
           "5px 15px;border-radius: 5px;min-width: 60px;margin: 3px;border: 1px solid transparent;}QMenu::item:selected {background-color: "
           "rgba(215, 130, 126, 16);}QMenu::item:pressed {background-color: rgba(215, 130, 126, 8);border: 1px solid rgba(234, 157, 52, "
           "8);}QMenu::right-arrow {image: url(:/icons/fluent/resources/TreeViewClose.png);min-width: 40px;min-height: "
           "18px;}QMenuBar:disabled {color: "
           "rgba(150, 150, 150);}QMenu::item:disabled {color: rgba(150, 150, 150);background-color: transparent;}QPushButton "
           "{background-color: rgba(215, 130, 126, 18);border-radius: 5px;color: #000000;padding: 7px 20px;margin-right: 5px;border: 1px "
           "solid transparent;}QPushButton:hover {background-color: rgba(215, 130, 126, 40);}QPushButton:pressed, "
           "QPushButton:pressed:focus {background-color: rgba(255, 255, 255, 7);border: 1px solid rgba(255, 255, 255, 8);color: "
           "#333333;border: 1px solid rgba(234, 157, 52, 8);}QPushButton:disabled {color: #9893a5;background-color: rgba(150, 150, 150, "
           ...
           "rgba(215, 130, 126, 18);}QListView::item:selected {border-radius: 5px;outline: 0;background-color: rgba(215, 130, 126, "
           "25);border-color: rgba(255, 255, 255, 0);}QTreeView {background-color: transparent;color: #000000;outline: "
           "0;selection-background-color: rgba(255, 255, 255, 100);}QTreeView::indicator, QTreeView::icon {margin: 6px;}QTreeView::item "
           "{color: #000000;min-width: 60px;padding: 5px 4px;background-color: transparent;outline: 0;}QTreeView::item:hover, "
           "QTreeView::item:focus {background-color: rgba(215, 130, 126, 18);outline: 0;}QTreeView::item:selected {color: "
           "#234123;background-color: transparent;outline: 0;}QTreeView::item:selected:active {background-color: rgba(215, 130, 126, "
           "25);outline: 0;}QTreeView::branch:has-children:closed {image: "
           "url(:/icons/fluent/resources/TreeViewClose.png);}QTreeView::branch:has-children:open {image: "
           "url(:/icons/fluent/resources/TreeViewOpen.png);}QTreeView::branch:has-children:open:hover {image: "
           "url(:/icons/fluent/resources/TreeViewOpen.png);}QHeaderView "
           ...
           "#9893a5;padding: 4px;border-radius: 0;}QHeaderView::section:hover {background-color: "
           "rgba(255, 255, 255, 28);}QHeaderView::up-arrow {margin-top: 2px;margin-bottom: 2px;margin-right: 5px;width: 19px;height: "
           "13px;}QHeaderView::down-arrow {margin-bottom: 4px;margin-right: 5px;width: 19px;height: 13px;}QHeaderView::up-arrow {image: "
           "url(:/icons/fluent/resources/SpinBoxDown.png);}QHeaderView::down-arrow {image: "
           "url(:/icons/fluent/resources/SpinBoxUp.png);}QTabWidget::pane {border: 0px solid "
           "rgba(255, 255, 255, 40);border-radius: 5px;}QTabWidget::tab-bar {left: 8px;}QTabBar::tab {background-color: rgba(0, 0, "
           "0, 0);padding: 8px 15px;margin-right: 8px;margin-bottom: 2px;border-radius: 5px;}QTabBar::tab:hover {background-color: "
           ...
           "none;width: 0px;height: 0px;}QAbstractScrollArea {background-color: #ffffff;}QProgressBar {text-align: "
           "right;background-color: "
           "qlineargradient(spread:reflect, x1:0.5, y1:0.5, x2:0.5, y2:1, stop:0.119403 rgba(255, 255, 255, 20), stop:0.273632 rgba(255, "
           "255, "
           "255, 0));border-radius: 1px;margin-top: 14px;margin-bottom: 14px;margin-right: 30px;}QProgressBar::chunk {background-color: "
           "qlineargradient(spread:reflect, x1:0.5, y1:0.5, x2:0.5, y2:1, stop:0.119403 rgba(255, 255, 255, 250), stop:0.273632 rgba(255, "
           "255, "
           "255, 0));border-radius: 2px;}QSpinBox {background-color: rgba(255, 255, 255, 10);border: 1px solid rgba(255, 255, 255, "
           ...
           "rgba(0, 0, 0, 200);border-bottom: 2px solid #d7827e;}QSpinBox::up-button {image: "
           "url(:/icons/fluent/resources/SpinBoxUp.png);background-color: rgba(255, 255, 255, 0);border: 1px solid rgba(255, 255, 255, "
           "0);border-radius: 4px;margin-top: "
           ...
           "5);}QSpinBox::down-button {image: url(:/icons/fluent/resources/SpinBoxDown.png);background-color: rgba(0, 0, 0, "
           "0);border: 1px solid rgba(0, 0, "
           ...
           "{image: url(:/icons/fluent/resources/SpinBoxUpDisabled.png);}QSpinBox::down-button:disabled {image: "
           "url(:/icons/fluent/resources/SpinBoxDownDisabled.png);}QDoubleSpinBox {background-color: rgba(255, 255, 255, 10);border: "
           "1px solid rgba(0, 0, "
           "0, 8);border-radius: 5px;padding-left: 10px;padding-top: 6px;padding-bottom: 6px;min-width: 70px;border-bottom: 1px solid "
           ...
           "rgba(0, 0, 0, 13);color: rgba(255, 255, 255, 200);border-bottom: 2px solid #d7827e;}QDoubleSpinBox::up-button {image: "
           "url(:/icons/fluent/resources/SpinBoxUp.png);background-color: rgba(255, 255, 255, 0);border: 1px solid rgba(255, 255, 255, "
           "0);border-radius: 4px;margin-top: "
           ...
           "5);}QDoubleSpinBox::down-button {image: url(:/icons/fluent/resources/SpinBoxDown.png);background-color: rgba(255, 255, 255, "
           "0);border: 1px solid "
           "rgba(255, 255, 255, 0);border-radius: 4px;margin-top: 1px;margin-bottom: 1px;margin-right: 3px;min-width: 25px;max-width: "
           ...
           "url(:/icons/fluent/resources/SpinBoxUpDisabled.png);}QDoubleSpinBox::down-button:disabled {image: "
           "url(:/icons/fluent/resources/SpinBoxDownDisabled.png);}QDateTimeEdit {background-color: rgba(255, 255, 255, 10);border: "
           "1px solid rgba(0, 0, "
           "0, 8);border-radius: 5px;padding-left: 10px;padding-top: 6px;padding-bottom: 6px;min-width: 100px;border-bottom: 1px solid "
           ...
           "5);}QDateTimeEdit::down-button {image: url(:/icons/fluent/resources/SpinBoxDown.png);background-color: rgba(255, 255, 255, "
           "0);border: 1px solid rgba(40, "
           "105, 131, 255);border-radius: 4px;margin-top: 1px;margin-bottom: 1px;margin-right: 2px;min-width: 25px;max-width: "
           "25px;min-height: "
           ...
           "50px;}QDateTimeEdit:disabled {color: rgba(150, 150, 150);background-color: rgba(255, 255, 255, 13);border: 1px solid rgba(0, "
           "0, 0, 5);}QDateTimeEdit::up-button:disabled {image: "
           "url(:/icons/fluent/resources/SpinBoxUpDisabled.png);}QDateTimeEdit::down-button:disabled "
           "{image: url(:/icons/fluent/resources/SpinBoxDownDisabled.png);}QComboBox {background-color: rgba(255, 255, 255, "
           "18);border-radius: "
           "5px;padding-left: 10px;padding-top: 5px;padding-bottom: 6px;}QGroupBox QComboBox {padding-top: 5px;padding-bottom: "
           "6px;}QComboBox:hover {background-color: rgba(255, 255, 255, 23);}QComboBox::down-arrow {image: "
           "url(:/icons/fluent/resources/ComboBox.png);width: "
           "40px;height: 40px;margin-left: 15px;}QGroupBox QComboBox::down-arrow {width: 38px;height: 40px;}QComboBox::drop-down "
           "{background-color: transparent;min-width: 50px;}QComboBox:disabled {color: rgba(150, 150, 150);background-color: rgba(0, "
           "0, 0, 13);}QComboBox::down-arrow:disabled {image: url(:/icons/fluent/resources/ComboBoxDisabled.png);}QComboBox "
           "QAbstractItemView "
           "{background-color: #ffffff;border-radius: 0px;border: 1px solid rgba(255, 255, 255, 8);selection-color: "
           "#000000;selection-background-color: rgba(255, 255, 255, 16);padding: 4px;}QTextEdit, QPlainTextEdit {background-color: "
           "rgba(255, 255, 255, 16);border: 1px solid rgba(255, 255, 255, 5);border-bottom: 1px solid #e0e0e0;}QTextEdit:hover, "
           ...
           "rgba(255, 255, 255, 16);border: 1px solid rgba(255, 255, 255, 5);color: #000000;border-bottom: 1px solid "
           "#707070;padding-left: 5px;}QLineEdit:hover {background-color: #0c0c13; "
           "border: 1px solid rgba(255, 255, 255, 10);border-bottom: 1px solid #e0e0e0;}QLineEdit:focus {border-bottom: 1px solid "
           "#d7827e;background-color: #fffdfa;border-top: 1px solid rgba(255, 255, 255, 7);border-left: 1px solid rgba(0, "
           "0, 0, 7);border-right: 1px solid rgba(255, 255, 255, 7);}QLineEdit:disabled {color: rgba(150, 150, 150);background-color: "
           ...
           "url(:/icons/fluent/resources/RadioButton.png);}QRadioButton::indicator:checked {background-color: #d7827e;border: 1px "
           "solid #d7827e;image: "
           "url(:/icons/fluent/resources/RadioButton.png);}QRadioButton::indicator:checked:hover {image: "
           "url(:/icons/fluent/resources/RadioButtonHover.png);}QRadioButton::indicator:checked:pressed {image: "
           "url(:/icons/fluent/resources/RadioButtonPressed.png);}QRadioButton:disabled {color: rgba(150, 150, "
           "150);}QRadioButton::indicator:disabled "
           ...
           "{background-color: #d7827e;border: 1px solid #d7827e;image: "
           "url(:/icons/fluent/resources/CheckBox.png);}QGroupBox::indicator:checked:hover, "
           ...
           "#d7827e;image: url(:/icons/fluent/resources/CheckBoxPressed.png);}QCheckBox::indicator:indeterminate, "
           "QGroupBox::indicator:indeterminate, "
           "QTreeView::indicator:indeterminate, QTableView::indicator:indeterminate {background-color: #d7827e;border: 1px solid "
           "#d7827e;image: url(:/icons/fluent/resources/CheckBoxInterminate.png);}QCheckBox::indicator:indeterminate:hover, "
           ...
           "url(:/icons/fluent/resources/CheckBoxInterminatePressed.png);}QCheckBox::indicator:indeterminate:disabled, "
           ...
           "url(:/icons/fluent/resources/CheckBoxInterminateDisabled.png);}QGroupBox::indicator:checked:disabled, "
           ...
           "#d1d1d1;image: url(:/icons/fluent/resources/CheckBoxDisabled.png);}QGroupBox::indicator:disabled, "
