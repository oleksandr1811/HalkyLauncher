...
QString HalkyTheme::appStyleSheet()
{
    return "QMainWindow, QDockWidget {background-color: #11111b;}QWidget {border-color: rgba(255, 255, 255, 8);font-family: \"Segoe UI "
           ...
           "#qswPages > QObject {background-color: #11111b;color: #ffffff;}QToolBar {background-color: transparent;spacing: 0;padding: "
           "8px;}QToolBar::separator {background: rgba(255, 255, 255, 20);height: 0;margin: 0;}QToolButton {background-color: rgba(255, "
           "255, 255, 0);border: 1px solid transparent;border-radius: 6px;padding: 2px;margin-left: 8px;}QToolButton[popupMode=\"1\"] "
           ...
           "8);color: #cdd6f4;}QToolButton::menu-indicator {image: url(:/icons/fluent_dark/resources/ComboBox.png);width: 32px;height: "
           "38px;}QToolButton::menu-arrow {image: url(:/icons/fluent_dark/resources/ComboBox.png);width: 20px;height: 100%;border-left: "
           ...
           "255, 255, 13);color: #c8c8c8;}QMenu {background-color: #11111b;padding-left: 1px;padding-top: 1px;border: 1px solid rgba(255, "
           ...
           "8);}QMenu::right-arrow {image: url(:/icons/fluent_dark/resources/TreeViewClose.png);min-width: 40px;min-height: "
           ...
           "#c8c8c8;border: 1px solid rgba(205, 214, 244, 8);}QPushButton:disabled {color: #aaaaaa;background-color: rgba(150, 150, 150, "
           ...
           "left;padding-bottom: 4px;padding-left: 4px;padding-right: 4px;border-bottom: 1px solid #cba6f7;}QGroupBox::title::disabled "
           ...
           "url(:/icons/fluent_dark/resources/TreeViewClose.png);}QTreeView::branch:has-children:open {image: "
           "url(:/icons/fluent_dark/resources/TreeViewOpen.png);}QTreeView::branch:has-children:open:hover {image: "
           "url(:/icons/fluent_dark/resources/TreeViewOpen.png);}QHeaderView "
           ...
           "#d8d8d8;padding: 4px;border-radius: 0;}QHeaderView::section:hover {background-color: "
           ...
           "url(:/icons/fluent_dark/resources/SpinBoxDown.png);}QHeaderView::down-arrow {image: "
           "url(:/icons/fluent_dark/resources/SpinBoxUp.png);}QTabWidget::pane {border: 0px solid "
           ...
           "url(:/icons/fluent_dark/resources/SpinBoxUp.png);background-color: rgba(0, 0, 0, 0);border: 1px solid rgba(0, 0, 0, "
           ...
           "5);}QSpinBox::down-button {image: url(:/icons/fluent_dark/resources/SpinBoxDown.png);background-color: rgba(0, 0, 0, "
           ...
           "{image: url(:/icons/fluent_dark/resources/SpinBoxUpDisabled.png);}QSpinBox::down-button:disabled {image: "
           "url(:/icons/fluent_dark/resources/SpinBoxDownDisabled.png);}QDoubleSpinBox {background-color: rgba(255, 255, 255, 10);border: "
           "1px solid rgba(255, 255, "
           "255, 8);border-radius: 5px;padding-left: 10px;padding-top: 6px;padding-bottom: 6px;min-width: 70px;border-bottom: 1px solid "
           "#707070;}QDoubleSpinBox:hover {background-color: rgba(255, 255, 255, 16);border: 1px solid rgba(255, 255, 255, "
           "13);border-bottom: 1px solid #707070;}QDoubleSpinBox::focus {background-color: rgba(255, 255, 255, 5);border: 1px solid "
           "rgba(255, 255, 255, 13);color: rgba(255, 255, 255, 200);border-bottom: 2px solid #cba6f7;}QDoubleSpinBox::up-button {image: "
           "url(:/icons/fluent_dark/resources/SpinBoxUp.png);background-color: rgba(0, 0, 0, 0);border: 1px solid rgba(0, 0, 0, "
           "0);border-radius: 4px;margin-top: "
           ...
           "5);}QDoubleSpinBox::down-button {image: url(:/icons/fluent_dark/resources/SpinBoxDown.png);background-color: rgba(0, 0, 0, "
           "0);border: 1px solid "
           ...
           "url(:/icons/fluent_dark/resources/SpinBoxUpDisabled.png);}QDoubleSpinBox::down-button:disabled {image: "
           "url(:/icons/fluent_dark/resources/SpinBoxDownDisabled.png);}QDateTimeEdit {background-color: rgba(255, 255, 255, 10);border: "
           "1px solid rgba(255, 255, "
           "255, 8);border-radius: 5px;padding-left: 10px;padding-top: 6px;padding-bottom: 6px;min-width: 100px;border-bottom: 1px solid "
           "#707070;}QDateTimeEdit:hover {background-color: rgba(255, 255, 255, 16);border: 1px solid rgba(255, 255, 255, "
           "13);border-bottom: 1px solid #707070;}QDateTimeEdit::focus {background-color: rgba(255, 255, 255, 5);border: 1px solid "
           "rgba(255, 255, 255, 13);color: rgba(255, 255, 255, 200);border-bottom: 2px solid #707070;}QDateTimeEdit::up-button {image: "
           "url(:/icons/fluent_dark/resources/SpinBoxUp.png);background-color: rgba(0, 0, 0, 0);border: 1px solid rgba(0, 0, 0, "
           "0);border-radius: 4px;margin-top: "
           ...
           "5);}QDateTimeEdit::down-button {image: url(:/icons/fluent_dark/resources/SpinBoxDown.png);background-color: rgba(0, 0, 0, "
           "0);border: 1px solid rgba(0, "
           ...
           "255, 255, 5);}QDateTimeEdit::up-button:disabled {image: "
           "url(:/icons/fluent_dark/resources/SpinBoxUpDisabled.png);}QDateTimeEdit::down-button:disabled "
           "{image: url(:/icons/fluent_dark/resources/SpinBoxDownDisabled.png);}QComboBox {background-color: rgba(255, 255, 255, "
           "18);border-radius: "
           ...
           "url(:/icons/fluent_dark/resources/ComboBox.png);width: "
           ...
           "255, 255, 13);}QComboBox::down-arrow:disabled {image: url(:/icons/fluent_dark/resources/ComboBoxDisabled.png);}QComboBox "
           "QAbstractItemView "
           ...
           "rgba(255, 255, 255, 16);border: 1px solid rgba(255, 255, 255, 5);border-bottom: 1px solid #707070;}QTextEdit:hover, "
           "QPlainTextEdit:hover "
           "{background-color: #0c0c13;}QTextEdit:focus, QPlainTextEdit:focus {border-bottom: 1px solid #cba6f7;background-color: #0c0c13; "
           "border-top: 1px solid #cba6f7;border-left: 1px solid #cba6f7; "
           "border-right: 1px solid #cba6f7;}QTextEdit:disabled, QPlainTextEdit:disabled {color: rgba(150, "
           ...
           "border: 1px solid rgba(255, 255, 255, 10);border-bottom: 1px solid #707070;}QLineEdit:focus {border-bottom: 1px solid "
           "#cba6f7;background-color: #0c0c13;border-top: 1px solid rgba(255, 255, 255, 7);border-left: 1px solid rgba(255, "
           ...
           "16);}QRadioButton::indicator:pressed {background-color: rgba(255, 255, 255, 20);border: 1px solid #434343;image: "
           "url(:/icons/fluent_dark/resources/RadioButton.png);}QRadioButton::indicator:checked {background-color: #cba6f7;border: 1px "
           "solid #cba6f7;image: "
           "url(:/icons/fluent_dark/resources/RadioButton.png);}QRadioButton::indicator:checked:hover {image: "
           "url(:/icons/fluent_dark/resources/RadioButtonHover.png);}QRadioButton::indicator:checked:pressed {image: "
           "url(:/icons/fluent_dark/resources/RadioButtonPressed.png);}QRadioButton:disabled {color: rgba(150, 150, "
           "150);}QRadioButton::indicator:disabled "
           "{border: 1px solid #646464;background-color: rgba(255, 255, 255, 0);}QSlider:vertical {min-width: 30px;min-height: "
           "100px;}QSlider::groove:vertical {width: 5px;background-color: rgba(255, 255, 255, 150);border-radius: "
           "2px;}QSlider::handle:vertical {background-color: #cba6f7;border: 4px solid #454545;height: 9px;min-width: 13px;margin: 0px "
           "-7px;border-radius: 8px;}QSlider::handle:vertical:hover {background-color: #cba6f7;border: 3px solid #454545;height: "
           "11px;min-width: 13px;margin: 0px -7px;border-radius: 8px;}QSlider::handle:vertical:pressed {background-color: #cba6f7;border: "
           "5px solid #454545;height: 7px;min-width: 13px;margin: 0px -7px;border-radius: 8px;}QSlider::groove:vertical:disabled "
           "{background-color: rgba(255, 255, 255, 75);}QSlider::handle:vertical:disabled {background-color: #454545;border: 6px solid "
           "#353535;}QSlider:horizontal {min-width: 100px;min-height: 30px;}QSlider::groove:horizontal {height: 3px;background-color: "
           "rgba(255, 255, 255, 150);border-radius: 1px;padding-left: 0px;padding-right: 0px;}QSlider::handle:horizontal "
           "{background-color: #cba6f7;border: 4px solid #454545;width: 9px;min-height: 13px;margin: -7px 0;border-radius: "
           "8px;}QSlider::handle:horizontal:hover {background-color: #cba6f7;border: 3px solid #454545;width: 11px;min-height: "
           "13px;margin: -7px 0;border-radius: 8px;}QSlider::handle:horizontal:pressed {background-color: #cba6f7;border: 5px solid "
           "#454545;width: 7px;min-height: 13px;margin: -7px 0;border-radius: 8px;}QSlider::groove:horizontal:disabled {background-color: "
           "rgba(255, 255, 255, 75);}QSlider::handle:horizontal:disabled {background-color: #454545;border: 6px solid #353535;}QCheckBox, "
           ...
           "15px;height: 15px;border-radius: 4px;border: 1px solid #606060;background-color: rgba(255, 255, 255, 0);margin-right: "
           ...
           "#505050;}QGroupBox::indicator:checked, QMenu::indicator:checked, QCheckBox::indicator:checked, QTreeView::indicator:checked "
           "{background-color: #cba6f7;border: 1px solid #cba6f7;image: "
           "url(:/icons/fluent_dark/resources/CheckBox.png);}QGroupBox::indicator:checked:hover, "
           "QMenu::indicator:checked:hover, QCheckBox::indicator:checked:hover, QTreeView::indicator:checked:hover {background-color: "
           "#cba6f7;border: 1px solid #cba6f7;}QGroupBox::indicator:checked:pressed, QMenu::indicator:checked:pressed, "
           "QCheckBox::indicator:checked:pressed, QTreeView::indicator:checked:pressed {background-color: #cba6f7;border: 1px solid "
           "#cba6f7;image: url(:/icons/fluent_dark/resources/CheckBoxPressed.png);}QCheckBox::indicator:indeterminate, "
           "QGroupBox::indicator:indeterminate, "
           "QTreeView::indicator:indeterminate, QTableView::indicator:indeterminate {background-color: #cba6f7;border: 1px solid "
           "#cba6f7;image: url(:/icons/fluent_dark/resources/CheckBoxInterminate.png);}QCheckBox::indicator:indeterminate:hover, "
           "QGroupBox::indicator:indeterminate:hover, QTreeView::indicator:indeterminate:hover, QTableView::indicator:indeterminate:hover "
           "{background-color: #cba6f7;border: 1px solid #cba6f7;}QCheckBox::indicator:indeterminate:pressed, "
           "QGroupBox::indicator:indeterminate:pressed, QTreeView::indicator:indeterminate:pressed, "
           "QTableView::indicator:indeterminate:pressed {background-color: #cba6f7;border: 1px solid #cba6f7;image: "
           "url(:/icons/fluent_dark/resources/CheckBoxInterminatePressed.png);}QCheckBox::indicator:indeterminate:disabled, "
           "QGroupBox::indicator:indeterminate:disabled, QTreeView::indicator:indeterminate:disabled, "
           "QTableView::indicator:indeterminate:disabled {border: 1px solid #404040;background-color: #404040;image: "
           "url(:/icons/fluent_dark/resources/CheckBoxInterminateDisabled.png);}QGroupBox::indicator:checked:disabled, "
           "QMenu::indicator:checked:disabled, "
           "QCheckBox::indicator:checked:disabled, QTreeView::indicator:checked:disabled {border: 1px solid #404040;background-color: "
           "#404040;image: url(:/icons/fluent_dark/resources/CheckBoxDisabled.png);}QGroupBox::indicator:disabled, "
           "QMenu::indicator:disabled, "
           "QCheckBox::indicator:disabled, QTreeView::indicator:disabled {border: 1px solid #404040;background-color: rgba(255, 255, 255, "
