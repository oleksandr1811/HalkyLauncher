...
{
    // clang-format off
    static const QString newLayoutQss = QStringLiteral(
        // ── Sidebar ──────────────────────────────────────────────────────────
        "#halkyNavBar {"
        ...
        "#navToggleBtn, #navItemBtn, #navActionBtn {"
        ...
        "  icon-size: 22px;"
        "}"
        "#navToggleBtn:hover, #navActionBtn:hover {"
        "  background-color: rgba(255,255,255,8);"
        "  color: #cdd6f4;"
        "}"
        "#navItemBtn:hover {"
        "  background-color: rgba(203,166,247,10);"
        "  color: #cdd6f4;"
        "}"
        "#navItemBtn:checked {"
        ...
        "}"
        "#newsCard:hover {"
        "  background-color: rgba(203,166,247,8);"
        "}"
        "#newsCardTitle {"
        "  font-size: 12px;"
        "  font-weight: 600;"
        ...
        "  color: #cba6f7;"
        "  border: 1px solid rgba(203,166,247,30);"
        "  border-radius: 8px;"
        "  padding: 4px 14px;"
        "  font-weight: 600;"
        "}"
        "#libraryAddBtn:hover {"
        "  background-color: rgba(203,166,247,35);"
        "}"
        ...
        "  padding: 4px 16px;"
        "}"
        "#actionBarPlayBtn:hover {"
        "  background-color: #d8b4fe;"
        "}"
        "#actionBarEditBtn, #actionBarDeleteBtn {"
        "  background-color: rgba(255,255,255,8);"
        "  color: #cdd6f4;"
        "  border-radius: 8px;"
        ...
        "  padding: 4px 16px;"
        "}"
        "#actionBarEditBtn:hover {"
        "  background-color: rgba(255,255,255,16);"
        "}"
        "#actionBarDeleteBtn:hover {"
        ...
        // ── Home page ─────────────────────────────────────────────────────────
        "#homePage, #homeContent, #homeScrollArea {"
        "  background-color: #11111b;"
        "}"
        "#homeHeader {"
        "  background: transparent;"
    ...
    static const QString legacyQss = QStringLiteral(
        "QMainWindow, QDockWidget {background-color: #11111b;}QWidget {border-color: rgba(255, 255, 255, 8);font-family: \"Segoe UI "
    ...
    static const QString overridesQss = QStringLiteral(
        ...
        "}"
        "#settingsTitleIcon { background: transparent; }"
        "#settingsTitleLabel {"
        "  color: #cdd6f4;"
        "  font-size: 16px;"
        "  font-weight: bold;"
        ...
        // Sidebar search box (inside #pageContainerList column)
        "#pageSearchBox {"
        "  background: rgba(255,255,255,6);"
        "  border: 1px solid #313244;"
        "  border-radius: 6px;"
        ...
        "  min-width: 110px;"
        "}"
        "#settingsOkBtn:hover { background: #d5b7f8; }"
        "#settingsOkBtn:pressed { background: #b891f5; }"
        "#settingsOkBtn:disabled { background: #45475a; color: #6c7086; }"

        // Content area header (page display name)
        "#settingsDialog #pageContainerHeader {"
        "  color: #cba6f7;"
        "  font-size: 16px;"
        "  font-weight: bold;"
        ...
        // Sidebar width override for settings (wider than NewInstanceDialog)
        "#settingsDialog #pageContainerList {"
        "  min-width: 170px;"
        "  max-width: 170px;"
        "}"

        // ── New Instance Dialog ───────────────────────────────────────────────
        // Header bar (icon + name + group)
        "#instanceHeaderWidget {"
        "  background: #181825;"
        "  border-bottom: 1px solid #313244;"
        "}"

        // Icon picker button
        "#instanceIconBtn, #instanceHeaderWidget QToolButton {"
        "  background: rgba(255,255,255,6);"
        "  border: 2px solid #313244;"
        "  border-radius: 10px;"
        "  padding: 0px;"
        "}"
        "#instanceIconBtn:hover, #instanceHeaderWidget QToolButton:hover {"
        "  background: rgba(203,166,247,15);"
        "  border-color: #cba6f7;"
        "}"

        // Instance name input
        "#instanceNameInput, #NewInstanceDialog QLineEdit#instNameTextBox {"
        "  background: transparent;"
        "  border: none;"
        ...
        "  font-weight: bold;"
        "  padding: 2px 4px;"
        "  selection-background-color: rgba(203,166,247,40);"
        "}"
        "#instanceNameInput:focus, #NewInstanceDialog QLineEdit#instNameTextBox:focus {"
        "  border-bottom-color: #cba6f7;"
        "}"
        "#instanceNameInput::placeholder {"
        "  color: #45475a;"
        "}"
        ...
        // Group combobox
        "#instanceGroupCombo, #NewInstanceDialog QComboBox#groupBox {"
        "  background: rgba(255,255,255,6);"
        "  border: 1px solid #313244;"
        "  border-radius: 6px;"
        "  color: #a6adc8;"
        ...
        "  min-height: 28px;"
        "}"
        "#instanceGroupCombo:focus, #instanceGroupCombo QLineEdit:focus {"
        "  border-color: #cba6f7;"
        "}"
        "#instanceGroupCombo QLineEdit {"
        "  background: transparent;"
        "  border: none;"
        "  color: #a6adc8;"
        "  font-size: 12px;"
        ...
        "  border: none;"
        "}"
        "#pageContainerList::item:selected {"
        "  background: rgba(203,166,247,18);"
        "  color: #cba6f7;"
        "}"
        "#pageContainerList::item:hover:!selected {"
        "  background: rgba(255,255,255,8);"
        "  color: #cdd6f4;"
        "}"

        // Page header label (current page display name)
        "#pageContainerHeader {"
        "  color: #6c7086;"
        "  font-size: 11px;"
        "  font-weight: normal;"
        ...
        // Content area in the page container
        "#NewInstanceDialog PageContainer {"
        "  background: #1e1e2e;"
        "}"
        "#NewInstanceDialog PageContainer > QWidget {"
        "  background: #1e1e2e;"
        "}"
    );
